...
export default function Upcoming() {
  return (
    <section id="upcoming" className="py-8 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex gap-4 overflow-x-auto snap-x snap-mandatory pb-3 scrollbar-none">
          ...
          {eventItems.length > 0 ? (
            ...
            <p className="text-center text-gray-600 text-sm italic w-full py-6">
              No events planned as of now
            </p>
          )}

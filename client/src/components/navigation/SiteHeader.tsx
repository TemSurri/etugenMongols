  ...
  return (
    ...
    <header className="fixed left-0 top-0 z-50 w-full border-b border-[#efe7d4] bg-white text-[#27301d] shadow-[0_10px_34px_rgba(39,48,29,0.07)]">
      ...
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between gap-3 px-4 sm:h-24 sm:px-6 lg:px-10">
        ...
        <DesktopNavigation currentPath={currentPath} handleNavClick={handleNavClick} />
        ...
        <div className="flex shrink-0 items-center justify-end gap-2 sm:gap-3">
          ...
          <DesktopAccountControls user={user} isLoggedIn={isLoggedIn} loading={loading} logout={logout} userMenuItems={userMenuItems} />
      ...
      {menuOpen && <MobileNavigation user={user} isLoggedIn={isLoggedIn} loading={loading} logout={logout} userMenuItems={userMenuItems} currentPath={currentPath} openMobileGroup={openMobileGroup} setOpenMobileGroup={setOpenMobileGroup} closeMenu={closeMenu} handleNavClick={handleNavClick} />}

...
export default function LanguageToggle({ lang, toggleLang }: Props) {
  return (
    <button
      type="button"
      onClick={toggleLang}
      className="grid h-10 w-[6.5rem] grid-cols-2 border border-[#e6dcc3] bg-[#fffaf0] p-1 text-[10px] font-bold uppercase tracking-[0.1em] text-[#27301d] transition-colors hover:border-[#d8caa5] sm:h-11 sm:w-[7rem]"

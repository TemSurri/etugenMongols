  ...
  return (
    <section className="relative min-h-screen bg-[#27301d] pt-20 text-[#fffaf0]">
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="relative z-10 mx-auto max-w-7xl px-5 pb-20 pt-16 sm:px-6 sm:pb-24 sm:pt-18 md:px-10 lg:px-12"
      >
                ...
                {hasResults ? (
                  <>
                    <div className="md:hidden">
                      <GalleryTimeline items={filteredItems} copy={copy} />
                    </div>
                    <div className="hidden md:block">
                      {viewMode === "grid" ? (
                        <GalleryGrid items={filteredItems} copy={copy} />
                      ) : (
                        <GalleryTimeline items={filteredItems} copy={copy} />
                      )}
                    </div>

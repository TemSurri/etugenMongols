  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 p-8 text-[#fffaf0] sm:p-10 lg:p-12">
        <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-[#eee0b7]">
          {copy.slideshowEyebrow}
        </p>
        <h2
          id="past-events-title"
          className="mt-3 max-w-lg text-2xl font-normal leading-tight tracking-tight md:text-3xl"
        >
          {copy.slideshowTitle}
        </h2>
        <Link

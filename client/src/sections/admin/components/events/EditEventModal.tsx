      ...
      <div className="mt-2 flex flex-col gap-2 sm:flex-row sm:items-start">
        ...
        {multiline ? (
          ...
          <textarea
            ...
            rows={4}
            className="min-w-0 flex-1 resize-y border border-[#cfc19f] bg-white px-4 py-3 text-sm leading-6 outline-none focus:border-[#8d7020]"
          />
          ...
          <input
            ...
            className="min-w-0 flex-1 border border-[#cfc19f] bg-white px-4 py-3 text-sm outline-none focus:border-[#8d7020]"
          />
        ...
        <button
          ...
          disabled={saving}
          onClick={save}
          className="min-w-[90px] bg-[#303824] px-4 py-3 text-[9px] font-semibold uppercase tracking-[0.14em] text-[#fffaf0] disabled:opacity-50"
        >
          {saving
            ? "Saving"
            : saved

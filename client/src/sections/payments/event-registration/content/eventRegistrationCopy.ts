import type { Lang } from "../types/eventRegistrationTypes";
...
export type EventRegistrationCopy = {
  ...
  registrationIntro: (price: string) => string;
...
export const EVENT_REGISTRATION_COPY: Record<Lang, EventRegistrationCopy> = {
  en: {
    backToEvent: "Back to event",

    registerFor: "Register for",

    registrationIntro: (price: string) =>
    ...
    noAdditionalGuests: "No additional guests yet.",
    ...
    existingPaymentTitle: "Existing payment",
    ...
    continueExistingPayment: "Continue payment",

    cancelExistingPayment: "Cancel payment",
    ...
    paymentPayer: "Registrant",

    paymentAttendees: "Attendees",
    ...
    paymentTitle: "Complete registration",

    paymentDescription: "Complete your payment to finish registering.",

    paymentComplete: "Registration complete",

    donationPaymentTitle: "Complete donation",

    donationPaymentDescription: "Complete your existing donation payment.",

    completeDonation: "Complete donation",
  },

  mn: {
    backToEvent: "Арга хэмжээ рүү буцах",

    registerFor: "Бүртгүүлэх",
    ...
    confirmEmail: "Имэйлээ давтан оруулна уу",
    ...
    additionalGuests: "Нэмэлт зочид",

    additionalGuestsDescription: "Тантай хамт оролцох хүмүүсийг нэмнэ үү.",
    ...
    noAdditionalGuests: "Одоогоор нэмэлт хүн алга.",

    registrationSummary: "Бүртгэлийн мэдээлэл",

    pricePerGuest: "Нэг хүний үнэ",
    ...
    continueToPayment: "Төлбөр үргэлжлүүлэх",

    preparingPayment: "Төлбөр бэлдэж байна…",

    existingPaymentTitle: "Үргэлжилж буй төлбөр",

    existingPaymentDescription:
      "Танд аль хэдийн үргэлжилж буй төлбөр байна. Шинэ төлбөр эхлүүлэхээс өмнө үргэлжлүүлэх эсвэл цуцлах боломжтой.",

    continueExistingPayment: "Төлбөр үргэлжлүүлэх",

    cancelExistingPayment: "Төлбөр цуцлах",

    cancel: "Цуцлах",

    currentPayment: "Одоогийн төлбөр",
    ...
    paymentPayer: "Бүртгүүлэгч",

    paymentAttendees: "Оролцогчид",
    ...
    paymentTitle: "Бүртгэл дуусгах",

    paymentDescription: "Бүртгэлээ дуусгахын тулд төлбөрөө хийнэ үү.",

    paymentComplete: "Бүртгэл амжилттай",

    donationPaymentTitle: "Хандив дуусгах",

    donationPaymentDescription: "Үргэлжилж буй хандивын төлбөрөө дуусгана уу.",

    completeDonation: "Хандив дуусгах",
  },
};

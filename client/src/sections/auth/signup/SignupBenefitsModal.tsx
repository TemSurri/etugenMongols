...
export default function SignupBenefitsModal({
  showWhyAccount,
  setShowWhyAccount,
  language,
}: {
  showWhyAccount: boolean;
  setShowWhyAccount: (value: boolean) => void;
  language: "en" | "mn";
}) {
  const dialogRef = useDialogFocus(showWhyAccount);
  useEffect(() => {
    if (!showWhyAccount) return;
    const onKeyDown = (event: KeyboardEvent) => {
      if (event.key === "Escape") setShowWhyAccount(false);
    };
    window.addEventListener("keydown", onKeyDown);
    return () => window.removeEventListener("keydown", onKeyDown);
  }, [showWhyAccount, setShowWhyAccount]);
  return (
    <AnimatePresence>
      {showWhyAccount && (
        <motion.div
          ...
          role="dialog"
          aria-modal="true"
          aria-label={language === "mn" ? "Бүртгэл" : "Account"}
          tabIndex={-1}
          initial={{
            opacity: 0,
          }}
          ...
          className="
                            ...
                            backdrop-blur-[2px]
                        "
          onClick={() => setShowWhyAccount(false)}
        >
          <motion.div
            initial={{
              opacity: 0,
              ...
              {language === "en" ? (
                ...
                "
                  >
                    ...
                    Creating one simply makes it easier to get involved, stay
                    connected, and keep track of your activity with us.
                  </p>
                ...
                "
                  >
                    Та бүртгэлгүйгээр хандив өгөх болон тасалбар авах боломжтой.
                    Бүртгэл үүсгэснээр бидний үйл ажиллагаанд оролцох, холбоотой
                    байх, өөрийн түүхээ хянах илүү хялбар болно.
                  </p>

export const accountCopy = {
  en: {
    title: "My Account",
    subtitle: "Manage your profile, security settings, and account activity.",
    ...
    security: {
      ...
      changingEmail: "Sending verification...",
    ...
    history: {
      ...
      emptyBody: "Your recent account activity will appear here.",
    },
  },
  ...
  mn: {
    ...
    profile: {
      ...
      changingName: "Хадгалж байна...",

      nameSuccess: "Таны нэр амжилттай шинэчлэгдлээ.",

      invalidName: "Нэр болон овгоо зөв оруулна уу.",
    ...
    security: {
      ...
      changingEmail: "Баталгаажуулах холбоос илгээж байна...",

      changingPassword: "Нууц үгийг шинэчилж байна...",
      ...
      passwordSuccess: "Таны нууц үг амжилттай шинэчлэгдлээ.",

      emailMismatch: "Имэйл хаягууд таарахгүй байна.",
      ...
      incorrectPassword: "Таны одоогийн нууц үг буруу байна.",
    ...
    history: {
      title: "Түүх",
      emptyTitle: "Одоогоор үйл ажиллагаа алга",
      emptyBody: "Таны сүүлийн бүртгэлийн үйл ажиллагаа энд харагдана.",
    },
  },
} as const;

...
export function SecuritySection({ email, copy }: SecuritySectionProps) {
      ...
      <div className="mt-6 divide-y divide-[#27301d]/10">
        <div className="py-4">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="text-sm font-medium text-[#667056]">{copy.email}</p>

              <p className="mt-1 text-sm font-medium text-[#27301d]">{email}</p>
            </div>

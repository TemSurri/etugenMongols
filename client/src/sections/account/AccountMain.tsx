...
import { accountCopy } from "./content/accountCopy";
...
export default function AccountMain({ lang }: AccountMainProps) {
    ...
    >
      ...
      <motion.div
        ...
        className="
                ...
                "
      >
        <motion.div className="mt-8 space-y-1" variants={itemVariants}>
        ...
        <div className="mt-2 space-y-6">
          <motion.div variants={itemVariants}>
            <ProfileSection user={user} copy={copy.profile} />
          </motion.div>

          <motion.div variants={itemVariants}>
            <SecuritySection email={user.email} copy={copy.security} />
          </motion.div>

          <motion.div variants={itemVariants}>
            <HistorySection copy={copy.history} />
          </motion.div>
        </div>
      </motion.div>
    </div>
